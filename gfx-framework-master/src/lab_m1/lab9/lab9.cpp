...
void Lab9::Update(float deltaTimeSeconds)
{
    ...
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(3, 0.5f, 3));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.5f));
...
void Lab9::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, Texture2D* texture1, Texture2D* texture2)
{
    ...
    int loc_mix = glGetUniformLocation(shader->program, "mixx");
    ...
    if (texture1)
    {
        ...
        int loc_text1 = glGetUniformLocation(shader->GetProgramID(), "texture_1");
        glUniform1i(loc_text1,  0);
    ...
    if (texture2)
    {
        ...
        int loc_text2 = glGetUniformLocation(shader->GetProgramID(), "texture_2");
        glUniform1i(loc_text2, 1);
