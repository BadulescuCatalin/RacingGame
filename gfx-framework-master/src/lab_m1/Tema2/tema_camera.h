...
namespace implemented2
{
    ...
    public:
        ...
        glm::vec3 cameraPositionToCheck(float distance) {
            glm::vec3 dir = glm::normalize(glm::vec3(forward.x, 0, forward.z));
            glm::vec3 newPos = dir * distance + GetTargetPosition();
            return newPos;
        }
        ...
        void TranslateRight(float distance)
        {
            ...
            glm::vec3 projection = glm::vec3(right.x, 0, right.z);
            position += glm::normalize(projection) * distance;
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            right = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1), angle, forward) * glm::vec4(right, 0)));
            up = glm::normalize(glm::cross(right, forward));
        }
